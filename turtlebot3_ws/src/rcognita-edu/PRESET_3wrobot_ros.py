...
# -*- coding: utf-8 -*-
"""
ROS-Preset: a 3-wheel robot (kinematic model a. k. a. non-holonomic integrator).
...
class ROS_preset:
    ...
    def odometry_callback(self, msg):
        ...
        y = msg.pose.pose.position.y   # Complete!
        ...
        state_matrix = np.vstack([self.state_goal[0], self.state_goal[1],self.state_goal[2]])
         
        t_matrix = np.block([rotation_matrix, state_matrix],
                [0, 0, 0, 1])
        
        # Check lecture 3, for transformation
        
        '''Your solution goes here!'''
        
        self.new_state = [new_state[0], new_state[1], theta]    # Complete!
    ...
    def spin(self, is_print_sim_step=False, is_log_data=False):
        ...
        while rospy.is_shutdown() and time_lib() - start_time < 100:
            ...
            action = controllers.ctrl_selector(self.t, self.new_state, action_manual, self.ctrl_manual, self.ctrl_benchm, self.ctrl_mode)
